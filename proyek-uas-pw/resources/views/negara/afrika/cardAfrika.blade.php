...
@section('content')
    <div class="container py-5">
        <div class="d-flex align-items-center mb-4">
            ...
            <a href="{{ route('afrika.create') }}" class="btn btn-primary ms-auto">Tambah</a>
        </div>
        <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="card destination-card position-relative">
                        <a href="{{ route('afrika.detail', ['id' => $list->id]) }}">
                            <img src="{{ asset('assets/img/' . $list->image_afrika) }}" class="card-img-top destination-img"
                                alt="{{ $list->negara_afrika }}" />
                        </a>
                        <div class="card-overlay">
                            <h5 class="card-title">{{ $list->negara_afrika }}</h5>
                            <a href="{{ route('afrika.delete', ['id' => $list->id]) }}" class="btn btn-sm btn-danger">Hapus</a>
