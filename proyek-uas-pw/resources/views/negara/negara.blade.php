...
<body>
                ...
                <div class="col-md-4">
                    <div class="card destination-card position-relative">
                        <a href="{{ route('asia.detail', ['id' => $list->id]) }}">
                            <img src="{{ asset($list->image_asia) }}" class="card-img-top destination-img"
    ...
    <div class="container py-5">
        <div class="d-flex align-items-center my-4">
            <img src="{{ asset('assets/img/australia.png') }}" alt="australia Logo"
                style="height: 40px; margin-right: 12px;">
                ...
                <div class="col-md-4">
                    <div class="card destination-card position-relative">
                        <a href="{{ route('afrika.detail', ['id' => $list->id]) }}">
                            <img src="{{ asset($list->image_afrika) }}" class="card-img-top destination-img"
