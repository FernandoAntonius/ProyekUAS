...
class KotaAsiaController extends Controller
{
    ...
    public function create(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('kotaasia.list')->with('success', 'Kota berhasil ditambahkan');
        }
    ...
    public function edit(Request $request, $id)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('kotaasia.list')->with('success', 'Kota berhasil diupdate');
        }
    ...
    public function delete(Request $request, $id)
    {
        if ($request->isMethod('post')) {
            ...
            if ($deleted) {
                return redirect()->route('kotaasia.list')->with('success', 'Kota berhasil dihapus');
            } else {
